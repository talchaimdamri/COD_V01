...
import { CommonQuerySchema, SuccessResponseSchema, PaginatedResponseSchema, } from './common';
/**
...
export const ListEventsQuerySchema = CommonQuerySchema.extend({
    ...
    typePrefix: z
        .string()
        .optional()
        .describe('Filter by event type prefix (e.g., "CHAIN_" for all chain events)'),
    ...
    payloadContains: z
        .string()
        .optional()
        .describe('Filter events where payload contains specific text (JSON search)'),
    aggregateId: z
        .string()
        .optional()
...
export const GetEventResponseSchema = SuccessResponseSchema(EventResponseSchema).describe('Response for getting a single event');
// GET /events - List events with pagination
export const ListEventsResponseSchema = PaginatedResponseSchema(EventResponseSchema).describe('Response for listing events with pagination');
// POST /events - Create event
export const CreateEventResponseSchema = SuccessResponseSchema(EventResponseSchema).describe('Response for creating an event');
/**
 ...
 */
export const CreateEventsBatchResponseSchema = SuccessResponseSchema(z.object({
    created: z
 ...
 */
export const EventStatsResponseSchema = SuccessResponseSchema(z.object({
 ...
 */
export const ReplayEventsResponseSchema = SuccessResponseSchema(z.object({
 ...
 */
export const ValidateEventResponseSchema = SuccessResponseSchema(z.object({
