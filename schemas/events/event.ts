...
export const EventSchema = z.object({
  ...
  type: z
    ...
    .regex(
      /^[A-Z0-9_]+$/,
      'Event type must contain only uppercase letters, numbers, and underscores'
    )
  ...
  payload: z
    .any()
    .refine((val): val is any => val !== undefined, {
      message: 'payload is required',
    })
    .describe(
      'Event data payload - can be object, array, string, number, boolean, or null'
    ),
...
/**
 * TypeScript type inferred from EventSchema
 */
